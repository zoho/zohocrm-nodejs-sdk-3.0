...
class ContactRolesOperations{
	...
	async getContactRoles()	{
		...
		var apiPath = '';
		apiPath = apiPath.concat("/crm/v3/Contacts/roles");
	...
	async getAllContactRolesOfDeal(dealId, paramInstance=null)	{
		...
		var handlerInstance = new CommonAPIHandler();
		var apiPath = '';
		apiPath = apiPath.concat("/crm/v3/Deals/");
...
class GetAllContactRolesOfDealParam{
	...
	static FIELDS = new Param("fields", "com.zoho.crm.api.ContactRoles.GetAllContactRolesOfDealParam");
}
