...
class ConversionOptionsResponseWrapper{
	...
	setConversionoptions(conversionoptions)	{
		const ConversionOption = require("./conversion_option").MasterModel;
...
module.exports = {
	MasterModel : ConversionOptionsResponseWrapper,
	ConversionOptionsResponseWrapper : ConversionOptionsResponseWrapper
}
