...
class TagsOperations{
	...
	async getTags(paramInstance=null)	{
		...
		var apiPath = '';
		apiPath = apiPath.concat("/crm/v3/settings/tags");
	 ...
	 * @throws {SDKException}
	 */
	async addTagsToRecord(recordId, moduleAPIName, request, paramInstance=null)	{
		const BodyWrapper = require("./body_wrapper").MasterModel;
	 ...
	 * @throws {SDKException}
	 */
	async removeTagsFromRecord(recordId, moduleAPIName, request, paramInstance=null)	{
		const BodyWrapper = require("./body_wrapper").MasterModel;
		if((!(Object.prototype.toString.call(recordId) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: recordId EXPECTED TYPE: BigInt", null, null);
		}
