...
class Field{
	 ...
	 * @returns {SubformModule} An instance of SubformModule
	 */
	getSubform()	{
		return this.subform;
	 ...
	 */
	setSubform(subform)	{
		const SubformModule = require("./subform_module").MasterModel;
		if((subform != null) && (!(subform instanceof SubformModule)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: subform EXPECTED TYPE: SubformModule", null, null);
		}
	...
	setSharingProperties(sharingProperties)	{
		const SharingProperties = require("./sharing_properties").MasterModel;
	 ...
	 * @returns {AllowedPermissionsToUpdate} An instance of AllowedPermissionsToUpdate
	 */
	getAllowedPermissionsToUpdate()	{
	 ...
	 */
	setAllowedPermissionsToUpdate(allowedPermissionsToUpdate)	{
		const AllowedPermissionsToUpdate = require("./allowed_permissions_to_update").MasterModel;
		if((allowedPermissionsToUpdate != null) && (!(allowedPermissionsToUpdate instanceof AllowedPermissionsToUpdate)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: allowedPermissionsToUpdate EXPECTED TYPE: AllowedPermissionsToUpdate", null, null);
		}
		this.allowedPermissionsToUpdate = allowedPermissionsToUpdate;
		this.keyModified.set("allowed_permissions_to_update", 1);
