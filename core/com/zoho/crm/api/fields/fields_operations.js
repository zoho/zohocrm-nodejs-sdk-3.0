...
class FieldsOperations{
	 ...
	 * @param {String} include A String representing the include
	 */
	constructor(module=null, include=null){
		if((module != null) && (!(Object.prototype.toString.call(module) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: module EXPECTED TYPE: String", null, null);
		}
		if((include != null) && (!(Object.prototype.toString.call(include) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: include EXPECTED TYPE: String", null, null);
		}
		this.module = module;
	...
	async getFields(paramInstance=null)	{
		...
		await handlerInstance.addParam(new Param("include", "com.zoho.crm.api.Fields.GetFieldsParam"), this.include);
	...
	async getField(id)	{
		...
		await handlerInstance.addParam(new Param("include", "com.zoho.crm.api.Fields.GetFieldParam"), this.include);
		let ResponseHandler = require.resolve("./response_handler");
		return handlerInstance.apiCall(ResponseHandler, "application/json");
