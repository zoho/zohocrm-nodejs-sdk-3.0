...
class TransferringResponseWrapper{

	validateBeforeTransfer;
	keyModified = new Map();
	/**
	 * The method to get the validateBeforeTransfer
	 * @returns {Array} An Array representing the validateBeforeTransfer
	 */
	 ...
	 * @param {Array} validateBeforeTransfer An Array representing the validateBeforeTransfer
	 */
...
module.exports = {
	MasterModel : TransferringResponseWrapper,
	TransferringResponseWrapper : TransferringResponseWrapper
}
