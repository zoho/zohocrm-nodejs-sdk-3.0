...
class User extends Record{
	 ...
	 * @returns {String} A String representing the numberSeparator
	 */
	getNumberSeparator()	{
	 ...
	 * @param {String} numberSeparator A String representing the numberSeparator
	 */
	setNumberSeparator(numberSeparator)	{
		if((numberSeparator != null) && (!(Object.prototype.toString.call(numberSeparator) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: numberSeparator EXPECTED TYPE: String", null, null);
		}
	 ...
	 * @param {Date} shiftEffectiveFrom An instance of Date
	 */
	setShiftEffectiveFrom(shiftEffectiveFrom)	{
		if((shiftEffectiveFrom != null) && (!(shiftEffectiveFrom instanceof Date)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: shiftEffectiveFrom EXPECTED TYPE: Date", null, null);
		}
	...
	setCurrentShift(currentShift)	{
		const Shift = require("./shift").MasterModel;
