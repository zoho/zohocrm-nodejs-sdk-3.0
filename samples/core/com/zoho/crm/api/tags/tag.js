const { TagsOperations, AddTagsToMultipleRecordsParam, AddTagsToRecordParam, CreateTagsParam, GetRecordCountForTagParam, GetTagsParam, RemoveTagsFromMultipleRecordsParam, RemoveTagsFromRecordParam, UpdateTagParam, UpdateTagsParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/tags_operations");
const ZCRMTag = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/tag").Tag;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/response_wrapper").ResponseWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/body_wrapper").BodyWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/action_wrapper").ActionWrapper;
const RecordActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/record_action_wrapper").RecordActionWrapper;
const MergeWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/merge_wrapper").MergeWrapper;
const CountWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/count_wrapper").CountWrapper;
const ConflictWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/conflict_wrapper").ConflictWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/success_response").SuccessResponse;
...
class Tag {
    ...
    static async createTags(moduleAPIName) {
        ...
        for (let index = 0; index < 2; index++) {
            ...
            //Set Name to tag
            tag.setName("tag12" + index.toString());
    ...
    static async addTagsToRecord(moduleAPIName, recordId, tagNames) {
        ...
        let response = await tagsOperations.addTagsToRecord(recordId, moduleAPIName,request,paramInstance);
                        ...
                        if (actionResponse instanceof SuccessResponse) {
                            ...
                            if (details != null) {
                                Array.from(details.keys()).forEach(key => 
                                {
                                    if(key == "tags")
                                    {
                                        let tags = details.get(key);

                                        tags.forEach(tag => {

                                            console.log("Tag ColorCode: " + tag.getColourCode());
    ...
    static async removeTagsFromRecord(moduleAPIName, recordId, tagNames) {
        ...
        let response = await tagsOperations.removeTagsFromRecord(recordId, moduleAPIName, request,paramInstance);
        ...
        if (response != null) {
            ...
            if (responseObject != null) {
                ...
                if (responseObject instanceof RecordActionWrapper) {
					...
					if (responseObject.getLockedCount != null)
					{
						console.log("Locked Count: " + responseObject.getLockedCount().toString());
					}

					// Check if success count is null
					if (responseObject.getSuccessCount() != null)
					{
						console.log("Success Count: " + responseObject.getSuccessCount());
					}

					// Check if wf scheduler is null
					if (responseObject.getWfScheduler() != null)
					{
						console.log("WF Scheduler: " + responseObject.getWfScheduler());
					}
                }
                //Check if the request returned an exception
                else if (responseObject instanceof APIException) {
    ...
    static async removeTagsFromMultipleRecords(moduleAPIName, recordIds, tagNames) {
        ...
        request.setIds(["5247206000000661001"]);
