const PipelineOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/pipeline_operations").PipelineOperations;
const TransferAndDeleteWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/transfer_and_delete_wrapper").TransferAndDeleteWrapper;
const PickListValue = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/pick_list_value").PickListValue;
const Stage = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/stage").Stage;
const TransferPipeLine = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/transfer_pipe_line").TransferPipeLine;
const PipeLineClass = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/pipeline").Pipeline;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/body_wrapper").BodyWrapper;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/api_exception").APIException;
const TransferActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/transfer_action_wrapper").TransferActionWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/action_wrapper").ActionWrapper;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/pipeline/success_response").SuccessResponse;
...
class PipeLine {
    ...
    static async createPipelines(layoutId) {
        ...
        pipeline.setDisplayValue("Tester2");

        let pickList = new PickListValue();

        pickList.setSequenceNumber(2);

        pickList.setId(5247206000000480046n);
    ...
    static async updatePipelines(layoutId) {
        ...
        pipeline.setId(5247206000000731083n);
