const WizardsOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/wizards/wizards_operations").WizardsOperations;
const ParameterMap = require("@zohocrm/nodejs-sdk-3.0/routes/parameter_map").ParameterMap;
const GetWizardbyIDParam = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/wizards/wizards_operations").GetWizardbyIDParam;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/wizards/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/wizards/api_exception").APIException;
