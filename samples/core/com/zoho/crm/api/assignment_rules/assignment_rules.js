...
const AssignmentRulesOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/assignment_rules/assignment_rules_operations").AssignmentRulesOperations;
const GetAssignmentRuleParam = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/assignment_rules/assignment_rules_operations").GetAssignmentRuleParam;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/assignment_rules/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/assignment_rules/api_exception").APIException;
