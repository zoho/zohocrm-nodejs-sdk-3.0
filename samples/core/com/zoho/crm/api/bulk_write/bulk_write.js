...
const { BulkWriteOperations, UploadFileHeader } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/bulk_write_operations");
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/success_response").SuccessResponse;
const BulkWriteResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/bulk_write_response").BulkWriteResponse;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/api_exception").APIException;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/file_body_wrapper").FileBodyWrapper;
const RequestWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/request_wrapper").RequestWrapper;
const CallBack = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/call_back").CallBack;
const Resource = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/resource").Resource;
const FieldMapping = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_write/field_mapping").FieldMapping;
