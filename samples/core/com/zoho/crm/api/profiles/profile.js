const ProfilesOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/profiles/profiles_operations").ProfilesOperations;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/profiles/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/profiles/api_exception").APIException;
