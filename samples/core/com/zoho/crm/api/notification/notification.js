const { NotificationOperations, DisableNotificationsParam, GetNotificationDetailsParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/notification_operations");
const ParameterMap = require("@zohocrm/nodejs-sdk-3.0/routes/parameter_map").ParameterMap;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/success_response").SuccessResponse;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/body_wrapper").BodyWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/action_wrapper").ActionWrapper;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/response_wrapper").ResponseWrapper;
const ZCRMNotification = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notification/notification").Notification;
