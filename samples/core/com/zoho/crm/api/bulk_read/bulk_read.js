...
const BulkReadOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/bulk_read_operations").BulkReadOperations;
const RequestWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/request_wrapper").RequestWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/action_wrapper").ActionWrapper;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/file_body_wrapper").FileBodyWrapper;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/success_response").SuccessResponse;
const CallBack = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/call_back").CallBack;
const Criteria = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/criteria").Criteria;
const Query = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/bulk_read/query").Query;
const Choice = require("@zohocrm/nodejs-sdk-3.0/utils/util/choice").Choice;
const Module = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/module").Module;
const Field = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/fields/field").Field;
...
class BulkRead {
    ...
    static async createBulkReadJob(moduleAPIName) {
        ...
        //Specifies the unique ID of the custom view, whose records you want to export.
         query.setCvid("5247206000000087501");
