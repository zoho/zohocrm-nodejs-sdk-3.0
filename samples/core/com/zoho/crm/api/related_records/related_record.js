const { RelatedRecordsOperations, DelinkRecordsParam, GetRelatedRecordHeader, GetRelatedRecordsHeader, GetRelatedRecordsParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/related_records_operations");
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/response_wrapper").ResponseWrapper;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/file_body_wrapper").FileBodyWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/body_wrapper").BodyWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/action_wrapper").ActionWrapper;
const ZCRMRecord = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/record").Record;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_records/success_response").SuccessResponse;
...
class RelatedRecord {
    ...
    static async getRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
        ...
        await paramInstance.add(GetRelatedRecordsParam.FIELDS, "id")
    ...
    static async updateRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
         ...
         * 2 -> Value
         */
        record1.addKeyValue("id", 1234567890n);
