const InitializeBuilder = require("@zohocrm/nodejs-sdk-3.0/routes/initialize_builder.js").InitializeBuilder;
const OAuthBuilder = require("@zohocrm/nodejs-sdk-3.0/models/authenticator/oauth_builder.js").OAuthBuilder;
const UserSignature = require("@zohocrm/nodejs-sdk-3.0/routes/user_signature").UserSignature;
const Levels = require("@zohocrm/nodejs-sdk-3.0/routes/logger/logger").Levels;
...
const DBBuilder = require("@zohocrm/nodejs-sdk-3.0/models/authenticator/store/db_builder.js").DBBuilder;
const FileStore = require("@zohocrm/nodejs-sdk-3.0/models/authenticator/store/file_store.js").FileStore;
const SDKConfigBuilder = require("@zohocrm/nodejs-sdk-3.0/routes/sdk_config_builder.js").SDKConfigBuilder;
const ProxyBuilder = require("@zohocrm/nodejs-sdk-3.0/routes/proxy_builder.js").ProxyBuilder;
...
class Initializer {
    ...
    static async initialize() {
         ...
         */
        let user = new UserSignature("user@zohocorp.com");
