const { ModulesOperations, GetModulesHeader } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/modules_operations");
const HeaderMap = require("@zohocrm/nodejs-sdk-3.0/routes/header_map").HeaderMap;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/success_response").SuccessResponse;
const ZCRMProfile = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/profiles/profile").Profile;
const ZCRMModule = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/module").Module;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/body_wrapper").BodyWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/modules/action_wrapper").ActionWrapper;
...
class Module {
    ...
    static async updateModuleByAPIName(moduleAPIName) {
        ...
        profile.setId(312938000000031161n);
