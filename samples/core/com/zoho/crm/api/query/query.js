const QueryOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/query/query_operations").QueryOperations;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/query/api_exception").APIException;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/query/response_wrapper").ResponseWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/query/body_wrapper").BodyWrapper;
