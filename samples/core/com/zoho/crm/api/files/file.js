...
const { FileOperations, GetFileParam, UploadFilesParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/file/file_operations");
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/file/file_body_wrapper").FileBodyWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/file/body_wrapper").BodyWrapper;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/file/success_response").SuccessResponse;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/file/api_exception").APIException;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/file/action_wrapper").ActionWrapper;
...
class File {
    ...
    static async uploadFiles() {
         ...
         */
        let streamWrapper2 = new StreamWrapper(null, null, "/home/ajeet-zt678/Documents/destination/Screenshot from 2022-07-01 11-49-01.png");
