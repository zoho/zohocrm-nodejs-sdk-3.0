const CurrenciesOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/currencies_operations.js").CurrenciesOperations;
const ZCRMCurrency = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/currency").Currency;
const Format = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/format").Format;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/response_wrapper").ResponseWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/action_wrapper").ActionWrapper;
const BaseCurrencyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/base_currency_wrapper").BaseCurrencyWrapper;
const BaseCurrencyActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/base_currency_action_wrapper").BaseCurrencyActionWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/success_response").SuccessResponse;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/currencies/body_wrapper").BodyWrapper;
...
static async addCurrencies() {
    ...
    //To set the number of decimal places allowed for the currency. It can be 0, 2, or 3.
    format.setDecimalPlaces(new Choice("0"));
...
static async updateCurrencies(){
    ...
    //To set currency Id
    currency.setId(5247206000000645001n);
