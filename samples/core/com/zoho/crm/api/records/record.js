...
const { RecordOperations, DeleteRecordParam, DeleteRecordsParam, GetDeletedRecordsHeader, GetDeletedRecordsParam, GetMassUpdateStatusParam, GetRecordHeader, GetRecordParam, GetRecordsHeader, GetRecordsParam, SearchRecordsParam, UpdateRecordHeader, DeleteRecordHeader, CreateRecordsHeader, UpdateRecordsHeader, DeleteRecordsHeader, UpsertRecordsHeader, SearchRecordsHeader, RecordCountParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/record_operations");
const { User } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/users/user");
const Participants = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/participants").Participants;
const Territory = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/territory").Territory;
const StreamWrapper = require("@zohocrm/nodejs-sdk-3.0/utils/util/stream_wrapper").StreamWrapper;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/file_body_wrapper").FileBodyWrapper;
const ZCRMUser = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/users/user").User;
const FileDetails = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/file_details").FileDetails;
const RemindAt = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/remind_at").RemindAt;
const Participant = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/participants").Participants;
const RecurringActivity = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/recurring_activity").RecurringActivity;
const ZCRMRecord = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/record").MasterModel;
const ZCRMLayout = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/layouts/layout").Layout;
const PricingDetails = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/pricing_details").PricingDetails;
const LineItemProduct = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/line_item_product").LineItemProduct;
const Tag = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/tag").Tag;
const LineTax = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/line_tax").LineTax;
//const InventoryLineItems = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/inventory_line_items").InventoryLineItems;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/response_wrapper").ResponseWrapper;
const DeletedRecordsWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/deleted_records_wrapper").DeletedRecordsWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/body_wrapper").BodyWrapper;
const MassUpdateBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/mass_update_body_wrapper").MassUpdateBodyWrapper;
const MassUpdateActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/mass_update_action_wrapper").MassUpdateActionWrapper;
const MassUpdateResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/mass_update_response_wrapper").MassUpdateResponseWrapper;
const MassUpdateSuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/mass_update_success_response").MassUpdateSuccessResponse;
const MassUpdate = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/mass_update").MassUpdate;
const ConvertBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/convert_body_wrapper").ConvertBodyWrapper;
const LeadConverter = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/lead_converter").LeadConverter;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/action_wrapper").ActionWrapper;
const RecordField = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/field").Field;
const Consent = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/consent").Consent;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/success_response").SuccessResponse;
//const SuccessfulConvert = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/successful_convert").SuccessfulConvert;
const Comment = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/comment").Comment;
...
const Choice = require("@zohocrm/nodejs-sdk-3.0/utils/util/choice").Choice;
const Reminder = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/reminder").Reminder;
const Attachment = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/attachment").Attachment;
const ImageUpload = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/image_upload").ImageUpload;
const Tax = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/tax").Tax;
const CarryOverTags = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/carry_over_tags").CarryOverTags;
const CountWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/count_wrapper").CountWrapper;
const ZCRMConversionOption = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/conversion_option.js").ConversionOption;
const ZCRMPreferenceFieldMatchedValue = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/preference_field_matched_value.js").PreferenceFieldMatchedValue;
const ConversionOptionsResponseWrapper = require("/home/ajeet-zt678/Documents/Dummy_trial/node_modules/zohocrm-nodejs-sdk-3.0/core/com/zoho/crm/api/record/conversion_options_response_wrapper.js").ConversionOptionsResponseWrapper;
class Record {
    /**
     * <h3> Get Record</h3>
    ...
    static async getRecord(moduleAPIName, recordId, destinationFolder) {
        ...
        await paramInstance.add(GetRecordParam.CVID, "5247206000000087501");
        ...
        await headerInstance.add(GetRecordHeader.IF_MODIFIED_SINCE, new Date("2022-07-12T15:26:49+05:30"));
    ...
    static async getRecordUsingExternalId(moduleAPIName, externalFieldValue, destinationFolder) {
        ...
        */
        ...
        /* Possible headers for Get Record operation*/
        await headerInstance.add(GetRecordHeader.IF_MODIFIED_SINCE, new Date("2022-07-13T22:40:44+05:30"));

        await headerInstance.add(GetRecordHeader.X_EXTERNAL, "Leads.Single_Line_1");
    ...
    static async updateRecordUsingExternalId(moduleAPIName, externalFieldValue) {
        ...
        record.addFieldValue(RecordField.Leads.LAST_NAME, "Zale");

        record.addFieldValue(RecordField.Leads.FIRST_NAME, "Krishan");
        ...
        let headerInstance = new HeaderMap();
         ...
         await headerInstance.add(UpdateRecordHeader.X_EXTERNAL, "Leads.Single_Line_1");
    ...
    static async getRecords(moduleAPIName) {
        ...
        /* Possible headers for Get Record operation*/
        await headerInstance.add(GetRecordsHeader.IF_MODIFIED_SINCE, new Date("2019-07-25T15:26:49+05:30"));
    ...
    static async createRecords(moduleAPIName) {
         ...
         * 2 . Value
         */
        record.addFieldValue(RecordField.Leads.LAST_NAME, "SDK_CRM");

        record.addFieldValue(RecordField.Leads.FIRST_NAME, "Node");

        record.addFieldValue(RecordField.Leads.COMPANY, "ZCRM");

        record.addFieldValue(RecordField.Leads.CITY, "Madurai");
        ...
        // record.addKeyValue("Date_1", new Date(2022, 11, 20));
    ...
    static async updateRecords(moduleAPIName) {
        ...
        record1.setId(5247206000000666007n);
         ...
         * 2 . Value
         */
        record1.addFieldValue(RecordField.Leads.CITY, "Indigo");

        record1.addFieldValue(RecordField.Leads.LAST_NAME, "Kannan");
    ...
    static async upsertRecords(moduleAPIName) {
         ...
         * 2 . Value
         */
        record1.addFieldValue(RecordField.Leads.CITY, "Madurai");

        record1.addFieldValue(RecordField.Leads.LAST_NAME, "SRC_SS");

        record1.addFieldValue(RecordField.Leads.FIRST_NAME, "FName");
    ...
    static async searchRecords(moduleAPIName) {
        ...
        await paramInstance.add(SearchRecordsParam.EMAIL, "ajeetkumar.k@zohocorp.com");

        await paramInstance.add(SearchRecordsParam.PHONE, "6381642356");
            ...
            if (responseObject != null) {
                ...
                if (responseObject instanceof ConvertActionWrapper) {
                    ...
                    convertActionResponses.forEach(convertActionResponse => {
                        //Check if the request is successful
                        if (convertActionResponse instanceof SuccessResponse) {
    ...
    static async uploadPhoto(moduleAPIName, recordId, absoluteFilePath) {
         ...
         * param 2 . Read Stream.
         */
        let streamWrapper = new StreamWrapper("myfile", fs.createReadStream(absoluteFilePath));
                ...
                if (responseObject instanceof MassUpdateActionWrapper) {
                    ...
                    massUpdateActionResponses.forEach(massUpdateActionResponse => {
                        ...
                        if (massUpdateActionResponse instanceof MassUpdateSuccessResponse) {
                            ...
                            if (details != null) {
                                Array.from(details.keys()).forEach(key => {
                                    if(details.get(key) instanceof ZCRMUser)
                                    {
                                      console.log(key + ': ' + details.get(key).getName() + ', id: ' + details.get(key).getId())
                                    } 
                                    else 
                                    {
                                        console.log(key + ": " + details.get(key));
                        ...
                        //Check if the request returned an exception
                            ...
                            //Get the details map
                            let details = massUpdateActionResponse.getDetails().toString();
    ...
    static async leadConversionOptions(recordId)
    {
       ...
       let response = await recordOperations.leadConversionOptions(recordId, moduleAPIName);
       ...
       if(response != null)
       {
           ...
           if(responseObject != null)
           {
             if(responseObject instanceof ConversionOptionsResponseWrapper)
             {
                 let conversionOption = responseObject.getConversionoptions();
                 
                 let module = ZCRMConversionOption.getModulePreference();
                ...
                let contacts = ZCRMConversionOption.getContacts();
                ...
                if(contacts != null)
                {
                    contacts.forEach(contact =>{
                       ...
                       let keyValues = contact.getKeyValues();
                ...
                {
                    let contactsPreferenceField = ZCRMPreferenceFieldMatchedValue.getContacts();
                    
                    if (contactsPreferenceField != null)
                    {
                        contactsPreferenceField.forEach(contacts => {

                            console.log("Record ID: " + contacts.getId());

						    console.log("Record KeyValues: ");

                            let keyValues = contacts.getKeyValues();
                ...
                if (accountsPreferenceField != null)
                {
                    accountsPreferenceField.forEach(account => {
                        ...
                        let keyValues = account.getKeyValues();
                ...
                if(dealsPreferenceField != null)
                {
                    dealsPreferenceField.forEach(deal =>{
                        ...
                        let keyValues = deal.getKeyValues();
                ...
                let  accoutns = ZCRMConversionOption.getAccounts();

                if (accoutns != null)
                {
                   accoutns.forEach(account =>
                   {
                    console.log("Record ID: " + account.getId());
                ...
                let deals = ZCRMConversionOption.getDeals();
               ...
               let modulesWithMultipleLayouts = ZCRMConversionOption.getModulesWithMultipleLayouts();

               if (modulesWithMultipleLayouts != null)
               {
                   modulesWithMultipleLayouts.forEach( module_1 => {

                    console.log("ConversionOptions ModulesWithMultipleLayouts API-Name: " + module_1.getAPIName());

                    console.log("ConversionOptions ModulesWithMultipleLayouts ID: " + module_1.getId());
                   })
               }
