const ZCRMVariable = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/variable").Variable;
const { VariablesOperations, DeleteVariablesParam, GetVariableByIDParam, GetVariableForAPINameParam, GetVariablesParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/variables_operations");
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/response_wrapper").ResponseWrapper;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/success_response").SuccessResponse;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/api_exception").APIException;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/body_wrapper").BodyWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variables/action_wrapper").ActionWrapper;
const VariableGroup = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/variable_groups/variable_group").VariableGroup;
...
class Variable {
    ...
    static async updateVariables() {
        ...
        variable1.setId( 5247206000000672033n);
