const { NotesOperations, DeleteNotesParam, GetNotesHeader, GetNotesParam, GetNoteHeader, GetNoteParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/notes_operations");
const ZCRMNote = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/note").Note;
...
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/response_wrapper").ResponseWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/action_wrapper").ActionWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/success_response").SuccessResponse;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/notes/body_wrapper").BodyWrapper;
...
class Note {
    ...
    static async createNotes() {
        ...
        for (let index = 0; index < 5; index++) {
            ...
            parentRecord.setId(5247206000000387408n);
    ...
    static async updateNotes() {
        ...
        //Set ID to Note
        note.setId(5247206000000387685n);
        ...
        //Set ID to Note
        note.setId(5247206000000387684n);
