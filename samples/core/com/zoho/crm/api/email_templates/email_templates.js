const { EmailTemplatesOperations, GetEmailTemplatesParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/email_templates/email_templates_operations");
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/email_templates/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/email_templates/api_exception").APIException;
