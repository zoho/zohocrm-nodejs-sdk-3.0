const FieldAttachmentsOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/field_attachments/field_attachments_operations").FieldAttachmentsOperations;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/field_attachments/file_body_wrapper").FileBodyWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/field_attachments/api_exception").APIException;
const fs = require("fs");
