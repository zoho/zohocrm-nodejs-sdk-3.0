...
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/action_wrapper").ActionWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/api_exception").APIException;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/response_wrapper").ResponseWrapper;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/file_body_wrapper").FileBodyWrapper;
const { AttachmentsOperations, GetAttachmentsParam, DeleteAttachmentsParam, UploadLinkAttachmentParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/attachments_operations");
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/attachments/success_response").SuccessResponse;
