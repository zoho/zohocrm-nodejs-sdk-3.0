const ZCRMBluePrint = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/blue_print").BluePrint;
const ZCRMRecord = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/record").Record;
const BluePrintOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/blue_print_operations").BluePrintOperations;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/response_wrapper").ResponseWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/body_wrapper").BodyWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/success_response").SuccessResponse;
const Transition = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/blue_print/transition").Transition;
...
class BluePrint {
    ...
    static async updateBlueprint(moduleAPIName, recordId, transitionId) {
        ...
        lookup.set("Phone", "999999999");

        lookup.set("id", "3333333");
