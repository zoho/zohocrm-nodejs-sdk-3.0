const {ContactRolesOperations, DeleteContactRolesParam} = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/contact_roles_operations.js");
const { ParameterMap } = require("@zohocrm/nodejs-sdk-3.0/routes/parameter_map.js");
const ZCRMContactRole = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/contact_role").ContactRole;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/action_wrapper").ActionWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/body_wrapper").BodyWrapper;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/success_response").SuccessResponse;
const RecordResponseHandler = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/record_response_handler").RecordResponseHandler;
const Record = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/record.js").Record;
const RecordActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/record_action_wrapper.js").RecordActionWrapper;
const RecordBodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/record_body_wrapper.js").RecordBodyWrapper;
const RecordResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/record_response_wrapper.js").RecordResponseWrapper;
const User = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/users/user.js").User;
const Tag = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/tags/tag.js").Tag;
const Info = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/record/info.js").Info;
const ContactRoleWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/contact_role_wrapper.js").ContactRoleWrapper;
const RecordActionHandler = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/record_action_handler.js").RecordActionHandler;
const GetAllContactRolesOfDealParam = require("/home/ajeet-zt678/Documents/Dummy_trial/node_modules/zohocrm-nodejs-sdk-3.0/core/com/zoho/crm/api/contact_roles/contact_roles_operations.js").ContactRolesOperations;
...
class ContactRole{
    ...
    static async createContactRoles() {
        ...
        for (let index = 1; index < 2; index++) {
            ...
            contactRole.setName("contactRole-NodeJS1" + index.toString());
    ...
    static async updateContactRoles() {
        ...
        cr1.setId( 5247206000000733001n);
        ...
        //Set ID to the ContactRole instance
        cr1.setId(5247206000000006873n);
    ...
    static async getAllContactRolesOfDeal(dealId) {
        ...
        //  await paramInstance.add(GetAllContactRolesOfDealParam.IDS,5247206000000648092n);

        await paramInstance.add(GetAllContactRolesOfDealParam.FIELDS, "Id");
    ...
    static async addContactRoleToDeal(contactId, dealId) {
        ...
        //Set name of the Contact Role
        contactRole.setContactRole("contactRole-node43");
