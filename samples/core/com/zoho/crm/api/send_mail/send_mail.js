const SendMailOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/send_mail_operations").SendMailOperations;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/response_wrapper").ResponseWrapper;
const Mail = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/mail").Mail;
const InventoryTemplate = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/inventory_templates/inventory_template").InventoryTemplate;
const BodyWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/body_wrapper").BodyWrapper;
const UserAddress = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/user_address").UserAddress;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/api_exception").APIException;
const ActionWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/action_wrapper").ActionWrapper;
const SuccessResponse = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/send_mail/success_response").SuccessResponse;
