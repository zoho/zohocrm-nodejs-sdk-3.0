const { InventoryTemplatesOperations, GetInventoryTemplatesParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/inventory_templates/inventory_templates_operations");
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/inventory_templates/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/inventory_templates/api_exception").APIException;
