const RelatedListsOperations = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_lists/related_lists_operations").RelatedListsOperations;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_lists/api_exception").APIException;
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/related_lists/response_wrapper").ResponseWrapper;
