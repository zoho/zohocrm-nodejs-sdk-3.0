const { CustomViewsOperations, GetCustomViewsParam } = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/custom_views/custom_views_operations");
const ResponseWrapper = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/custom_views/response_wrapper").ResponseWrapper;
const APIException = require("@zohocrm/nodejs-sdk-3.0/core/com/zoho/crm/api/custom_views/api_exception").APIException;
